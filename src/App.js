...
const portfolioData = {
  ...
  skills: {
    ...
    toolsOS: ["Eclipse", "STS", "Windows", "Linux", "VS Code"],
    softSkills: [
      "Collaboration",
      "Adaptability",
      "Time Management",
  ...
  projects: [
    {
      ...
      description:
        "Built a Convolutional Neural Network (CNN) model to detect and classify car damages from images, showcasing machine learning application.",
    },
    {
      title: "DevOps Monitoring Stack",
      description:
        "Deployed a comprehensive monitoring solution using Prometheus, Time Series Database, and Grafana on Kubernetes for scalable monitoring and insightful dashboards.",
    },
    {
      title: "CI/CD Pipeline for Full-Stack App",
      description:
        "Automated the build, test, and deployment process for a full-stack application using GitHub Actions, Jenkins, Docker, and AWS services.",
    },
  ],
};
  ...
  >
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center mb-8">
        {icon}
        <h2 className="text-3xl md:text-4xl font-bold text-slate-100 ml-4">
          {title}
        </h2>
      </div>
      {children}
        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex-shrink-0">
            <a
              ...
              className="text-2xl font-bold text-white transition-colors hover:text-teal-400"
            >
              {portfolioData.name}
            </a>
          </div>
...
const About = () => (
  ...
  >
    <div className="bg-slate-800/50 p-6 rounded-lg shadow-lg hover:shadow-teal-400/10 transition-shadow duration-300">
      <p className="text-slate-400 text-base">{portfolioData.objective}</p>
    </div>
  </Section>
);
...
const Experience = () => (
  <Section
    id="experience"
    title="Experience"
    icon={<Briefcase size={36} className="text-teal-400" />}
    className="bg-slate-900/50"
  >
    <div className="space-y-8">
      {portfolioData.experience.map((job, index) => (
        <div
          key={index}
          className="bg-slate-800/50 p-6 rounded-lg shadow-lg hover:shadow-teal-400/10 transition-shadow duration-300"
        >
...
const Skills = () => (
  <Section
    ...
    icon={<Code size={36} className="text-teal-400" />}
  >
    <div className="space-y-12">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {portfolioData.skills.programming.map((skill) => {
            const skillData = skillImages[skill] || {
              image: "💻",
              isImage: false,
            };
            return (
      ...
      <div>
        <h3 className="text-xl font-semibold text-slate-200 mb-6 flex items-center">
          <Wrench size={24} className="mr-3 text-teal-400" /> Tools & Operating
          Systems
        </h3>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {/* ... (SkillCard mapping for Tools & OS) */}
  ...
  >
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      {portfolioData.projects.map((project, index) => (
        <div
          key={index}
          className="bg-slate-800 p-6 rounded-lg shadow-lg flex flex-col transform hover:-translate-y-2 transition-transform duration-300"
        >
...
const Education = () => (
  <Section
    id="education"
    title="Education"
    icon={<GraduationCap size={36} className="text-teal-400" />}
  >
    <div className="space-y-8">
...
const Contact = () => {
  ...
  return (
    <Section
      id="contact"
      title="Get In Touch"
      icon={<Mail size={36} className="text-teal-400" />}
      className="bg-slate-900/50"
    >
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-lg text-slate-300 mb-8">
              ...
              from you. Feel free to reach out via the form, email, phone, or
